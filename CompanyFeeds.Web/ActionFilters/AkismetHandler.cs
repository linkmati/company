...
namespace CompanyFeeds.Web.ActionFilters
{
    ...
    public class AkismetHandlerComment
    {
    ...
    public class AkismetHandler
    {
        ...
        public AkismetHandler(string apiKey, string blog, string userAgent)
        {
            this.apiKey = apiKey;
        ...
        public bool CommentCheck(AkismetHandlerComment comment)
        {
            bool value = false;
        ...
        public void SubmitSpam(AkismetHandlerComment comment)
        {
        ...
        public void SubmitHam(AkismetHandlerComment comment)
        {
        ...
        private string CreateData(AkismetHandlerComment comment)
        {
