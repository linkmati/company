<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="CompanyFeeds.Web.UI.Es.Views.Agencies.Detail" %>
...
<%			if (Model.Url != null)
			{%>
				<p style="padding-bottom: 10px;"><strong>Web</strong>: <a href="<%=Model.Url %>"><%=UrlUtils.RemovePrefix(Model.Url)%></a></p>
<%			}%>
		</asp:Panel>
		<asp:Repeater ID="repSubmits" runat="server" DataSource='<%# ViewData["EntriesSubmitted"]%>'>
			<HeaderTemplate>
				<h2 style="padding-top: 20px;">Últimas notas de prensa enviadas por <%=Model.Name %></h2>
				<ul>
			</HeaderTemplate>
			<ItemTemplate>
