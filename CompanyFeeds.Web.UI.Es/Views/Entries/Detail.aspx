<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" AutoEventWireup="false" CodeBehind="Detail.aspx.cs" Inherits="CompanyFeeds.Web.UI.Es.Views.Entries.Detail" %>
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="HeadContent">
	<script type="text/javascript">
		...
		{
			alert("Gracias por reportar el error.\nUn administrador revisará la nota de prensa.");
		}
	...
	<div id="detail">
		...
		<div class="floatContainer">
			<h2>
				...
				<asp:Label runat="server" id="lblSubmitted"><br />Enviado por <%=Html.RenderUser(Model) %></asp:Label>
			</h2>
		</div>
		<div class="content">
			...
			<asp:Panel runat="server" ID="pnlOriginalSource" Visible="false">
				...
				<br />
				<p>Continuar leyendo en el sitio de <a href="<%= Model.EntrySource %>" target="_blank" rel="nofollow"><%=Model.CompanyName %> &gt;&gt;</a></p>
			</asp:Panel>
			<% Html.RenderPartialIf(!Model.IsPremium, "Adslot", new { SlotId = "5778617023", Width = 728, Height = 90 });%>
		</div>	
		<h3>Acerca de <%= Model.CompanyName  %></h3>
		<%= Model.CompanyDescription %>
		<p class="moreInfo"><%= Html.ActionLinkFormatted("Mas información acerca de " + Model.CompanyName, "Detail", "Companies", new{companyTag=Model.CompanyTag}, null)%></p>
