<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubscribeForm.ascx.cs" Inherits="CompanyFeeds.Web.UI.Es.Views.Shared.SubscribeForm" %>
...
<p id="noSubscriptionMessage" <%= ViewData["Companies"] != null ? "style=\"display:none;\"" : ""%>>Actualmente no estás siguiendo a ninguna empresa.</p>
...
<form onsubmit="subscriptions.add();return false;" class="subscribe" style="padding-bottom: 16px;">
	<label>Escribe el nombre de la empresa</label> <input type="text" class="text" id="companyName" />
	<input type="submit" class="button" id="Submit" value="Seguir" />
</form>