<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EntriesListControl.ascx.cs" Inherits="CompanyFeeds.Web.UI.Es.Views.Shared.EntriesListControl" %>
	...
	<ItemTemplate>
		...
		<li>
			...
			<p class="itemDetail">
				...
				- <%# Html.RenderDate(Eval("EntryDate"), "Hoy", "Ayer", "dd ' de ' MMM, yyyy") %> <%# Html.RenderUser((System.Data.DataRow)Container.DataItem, "por") %></p>
...
<%= Html.Pager(ViewData.Model, "<< Anterior", "Siguiente >>")%>