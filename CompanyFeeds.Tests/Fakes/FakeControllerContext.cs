...
namespace CompanyFeeds.Tests.Fakes
{
    ...
    public class FakeControllerContext : ControllerContext
	{
		...
		public FakeControllerContext(IController controller)
			: this(controller, "http://localhost/test.html", null, null, new NameValueCollection(), new NameValueCollection(), new HttpCookieCollection(), new SessionStateItemCollection())
		{
		}
