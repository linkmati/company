...
<form action="<%=Config.Payment.ServiceUrl %>" method="post"> 
	...
	<input type="hidden" name="cbt" value="Continue to prsync.com" />
	
	<!-- Identify the subscription. --> 
	<%-- The subscription: name, code and price --%>
	<input type="hidden" name="item_name" value="Premium subscription prsync.com" />
	...
	<a class="tri-button" href="#" onclick="$(this).closest('form').submit();return false;"><span>Buy now</span></a>
